...
import { User, FileText, Eye, BookOpen, Send, ShoppingCart, BriefcaseBusiness } from 'lucide-react';
import { NavLink } from 'react-router-dom';

const Navber = () => {
  return (
    <div className="w-full bg-white mt  flex items-center py-4 px-10 rounded-lg shadow-md space-x-16 ">
