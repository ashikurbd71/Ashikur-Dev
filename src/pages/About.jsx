...
const About = () => {
  ...
  <div className="container mx-auto text-left lg:p-10 p-5">
        <p className="text text-black font-semibold lg:text-2xl text-xl pb-4">Hello, I’m  <ReactTyped
...
/> </p>
        ...
        <p className="text-md lg:leading-relaxed lg:max-w-2xl mx-auto">
